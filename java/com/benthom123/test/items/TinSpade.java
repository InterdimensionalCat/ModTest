...
import net.minecraft.entity.SharedMonsterAttributes;
public class TinSpade extends ItemSpade {
	
	public Item repairItem;

	public TinSpade(String registryName, ToolMaterial material) {
        super(material);
	 ...
	 @Override
	    public Multimap<String, AttributeModifier> getAttributeModifiers(EntityEquipmentSlot slotIn, ItemStack stack)
	    {
	        ...
	        if (slotIn == EntityEquipmentSlot.MAINHAND) 
	      	{
	            replaceModifier(modifiers, SharedMonsterAttributes.ATTACK_SPEED /* or whatever attribute you want to modify */, ATTACK_SPEED_MODIFIER, (double)(0.875));
	            replaceModifier(modifiers, SharedMonsterAttributes.ATTACK_DAMAGE /* or whatever attribute you want to modify */, ATTACK_DAMAGE_MODIFIER, (double)(0.72));    
	        }
