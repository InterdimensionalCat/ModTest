...
public class LavaTinCan extends ItemBucket {
	
	private final Block containedBlock;
	
	public LavaTinCan(Block containedBlockIn) {

		super(containedBlockIn);
		this.maxStackSize = 1;
		this.containedBlock = containedBlockIn;
		setRegistryName("lavatincan");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName(modClass.MODID + ".lavatincan");     // Used for localization (en_US.lang)
    ...
    public net.minecraftforge.common.capabilities.ICapabilityProvider initCapabilities(ItemStack stack, @Nullable net.minecraft.nbt.NBTTagCompound nbt) {
        if (this.getClass() == LavaTinCan.class)
        {
