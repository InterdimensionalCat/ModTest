...
public class CopperNugget extends Item {
	...
	public CopperNugget() {
		...
		setRegistryName("coppernugget");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName(modClass.MODID + ".coppernugget");     // Used for localization (en_US.lang)
