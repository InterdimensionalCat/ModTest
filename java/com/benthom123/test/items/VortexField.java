...
public class VortexField extends PowerCrystal {
	
	BlockPos playerpos;
	int maxDamage;
	EntityPlayer user;

	public VortexField(String name) {
		super(name);
...
/*			this.playerpos = playerIn.getPosition();
	...
	private void makeVoidRift(ItemStack item, PotionType type, EntityPlayer playerIn, World worldIn)
	{
		...
		EntityVortexField voidrift = new EntityVortexField(worldIn, pos.getX() , pos.getY(), pos.getZ());
