...
public class ModSpade extends ItemSpade {
	...
	public ModSpade(String registryName, ToolMaterial material, double attackDamage, double attackSpeed, int repairIndex, CreativeTabs tab, double kickback, boolean customKnockback, boolean damage, boolean speed) {
		super(material);
