...
public class WaterTinCan extends ItemBucket {
	
	private final Block containedBlock;
	
	public WaterTinCan(Block containedBlockIn) {

		super(containedBlockIn);
		this.maxStackSize = 1;
		this.containedBlock = containedBlockIn;
		setRegistryName("watertincan");        // The unique name (within your mod) that identifies this item
        setUnlocalizedName(modClass.MODID + ".watertincan");     // Used for localization (en_US.lang)
   ...
   // this is something I tried that didn't work but I am saving for later
   // private Block getBlock(BlockPos posIn, World worldIn){
   //     IBlockState ibs = worldIn.getBlockState(posIn);
   ...
   // }
    ...
    public boolean tryPlaceContainedLiquid(@Nullable EntityPlayer player, World worldIn, BlockPos posIn)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                //worldIn.scheduleUpdate(posIn, getBlock(posIn, worldIn), 1);
                return true;
            }
        }
    }
    ...
    public net.minecraftforge.common.capabilities.ICapabilityProvider initCapabilities(ItemStack stack, @Nullable net.minecraft.nbt.NBTTagCompound nbt) {
        if (this.getClass() == WaterTinCan.class)
        {
