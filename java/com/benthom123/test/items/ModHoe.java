...
public class ModHoe extends ItemHoe {
	...
	public ModHoe(String registryName, ToolMaterial material, double attackSpeed, int repairIndex, CreativeTabs tab, double kickback, boolean customKnockback, boolean speed) {
		super(material);
