...
public class ModItems {
    ...
    public static SmokeShot smokeshot;
    
    @ObjectHolder("btm:invisible")
    public static EmptyCrystal invisible;
    
    @ObjectHolder("btm:emptycrystal")
    public static EmptyCrystal emptycrystal;
    
    @ObjectHolder("btm:voidrift")
    public static VoidRift voidrift;
    
    @ObjectHolder("btm:glacialspear")
    public static GlacialSpear glacialspear;
    
    @ObjectHolder("btm:healingrift")
    public static HealingRift healingrift;
    
    @ObjectHolder("btm:vortexfield")
    public static VortexField vortexfield;
    ...
    @ObjectHolder("btm:tttremington")
    public static TwoTwentyThreeRemington tttremington;
    
    @ObjectHolder("btm:arfifteen")
    public static ArmaLite15 arfifteen;
	...
	public static CreativeTabs powerCrystal = new ModTabs(CreativeTabs.getNextID(), "Magic", 99);
    ...
    public static void initModels() {
    	...
    	tinspade.initModel();
      	...
      	smokeshot.initModel();
      	invisible.initModel();
      	emptycrystal.initModel();
        voidrift.initModel();
        glacialspear.initModel();
        healingrift.initModel();
        vortexfield.initModel();
        tttremington.initModel();
        arfifteen.initModel();
